<template>
  <q-card>
    ...
    <q-card-section class="row justify-between center">
      <q-btn class="text-grey-6" size="12px" dense no-caps icon="add" label="Дело" flat rounded></q-btn>
      <div class="last-modified-date text-grey-6">12 minutes ago</div>
    </q-card-section>
  </q-card>
</template>
